...
```{r}
input_data <- read_delim(here::here("datasets", "atlas_reptilia","data","raw", "20230321_reptilia.csv"), ",")
```
...
```{r}
input_data <- input_data %>% select(-c(email, reproductivecondition,dateentered,firstname, lastname
                                       ,
